...
import { Building2, Users, FileText, Power, User, Plus, TrendingUp, Clock, UserCheck } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const dormantMembers = members?.filter((m) => m.status === 'dormant').length || 0;
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {((activeMembers / (members?.length || 1)) * 100).toFixed(0)}% of total
                  </p>
                </div>
